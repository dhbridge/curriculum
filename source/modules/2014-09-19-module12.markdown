...
To see the 50 most common words, add to the bottom of the 'Make Function Calls' section:
...
You can also see the words that only occur once by adding to the bottom of the 'Make Function Calls' section:
